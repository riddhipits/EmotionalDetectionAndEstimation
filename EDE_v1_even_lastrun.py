...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\HKU_PANDM_EDE_ShirleyLI\\Documents\\EDE_v1_ShirleyLI\\EDE_v1_even_lastrun.py',
...
BlockSequence1 = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('FNF_even.xlsx'),
...
for thisBlockSequence1 in BlockSequence1:
    ...
    Single_Block = data.TrialHandler(nReps=5, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Qn_FNF.xlsx', selection=str(thisBlock)+":"+str(thisBlock+5)),
    ...
    for thisSingle_Block in Single_Block:
        ...
        Reps_10 = data.TrialHandler(nReps=10, method='sequential', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('AsianTrials1.xlsx', selection=str(thisLoop)+":"+str(thisLoop+10)),
...
BlockSequence2 = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('NFN_even.xlsx'),
...
for thisBlockSequence2 in BlockSequence2:
    ...
    Single_Blockb = data.TrialHandler(nReps=5, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Qn_NFN.xlsx', selection=str(thisBlockb)+":"+str(thisBlockb+5)),
    ...
    for thisSingle_Blockb in Single_Blockb:
        ...
        Reps_10b = data.TrialHandler(nReps=10, method='sequential', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('AsianTrials2.xlsx', selection=str(thisLoopb)+":"+str(thisLoopb+10)),
